...
/*
 * Documentation:
 * Tabs — https://app.subframe.com/008548d9f5d8/library?component=Tabs_e1ad5091-8ad8-4319-b1f7-3e47f0256c20
 */
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        ...
        {
          "border-b-2 border-solid px-2.5 pt-0.5 pb-px border-gradient-to-r from-highlight-green to-highlight-blue relative hover:border-b-2 hover:border-solid hover:border-brand-600":
            active,
        },
        className
      )}
