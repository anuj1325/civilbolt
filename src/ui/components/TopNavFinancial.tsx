...
/*
 * Documentation:
 * top nav financial — https://app.subframe.com/008548d9f5d8/library?component=top+nav+financial_fe61a7fd-544b-4159-aa46-bfb3cb652afe
...
interface TopNavFinancialRootProps
  extends React.HTMLAttributes<HTMLDivElement> {
  text?: React.ReactNode;
  className?: string;
}

const TopNavFinancialRoot = React.forwardRef<
  HTMLDivElement,
  TopNavFinancialRootProps
>(function TopNavFinancialRoot(
  { text, className, ...otherProps }: TopNavFinancialRootProps,
  ref
) {
  return (
    <div
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <Breadcrumbs>
          <Breadcrumbs.Divider />
          <Breadcrumbs.Item active={true}>Financial details</Breadcrumbs.Item>
        </Breadcrumbs>
      </div>
...
export const TopNavFinancial = TopNavFinancialRoot;
