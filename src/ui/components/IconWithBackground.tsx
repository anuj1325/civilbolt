  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        "group/c5d68c0e flex h-5 w-5 items-center justify-center gap-2 rounded-full bg-brand-500",
        {
          "rounded-md": square,
          "h-6 w-6": size === "small",
          "h-8 w-8": size === "medium",
    ...
    >
      <SubframeCore.Icon
        className={SubframeUtils.twClassNames(
          "font-['Inter'] text-[10px] font-[400] leading-[12px] text-default-background",
          {
