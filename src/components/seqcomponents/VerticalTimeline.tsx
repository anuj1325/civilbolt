  ...
  return (
    <div className="transition-all duration-300 hover:shadow-lg w-full relative">
      ...
      >
        ...
        <div className="p-4">
          <div className="flex justify-between items-start">
            <div className="flex-1 min-w-0">
              <h3 className="text-body-bold font-body-bold text-gray-800 truncate">{letter.subject}</h3>
              <p className="text-caption font-caption text-gray-700 mt-1">{letter.letterNo}</p>
            </div>
        ...
        {isExpanded && (
          <div className="absolute top-full left-0 right-0 bg-white border border-t-0 rounded-b-lg shadow-lg z-20 px-4 pb-4 border-gray-100">
            <div className="space-y-3 pt-3">
              {/* Date and From info */}
              <div className="flex items-center space-x-4 text-caption font-caption text-gray-600">
              ...
              {/* Description */}
              <div>
                <p className="text-caption font-caption text-gray-600 leading-relaxed">
                  {letter.description}
                </p>
              </div>
              ...
              {letter.attachments.length > 0 && (
                <div>
                  <h4 className="text-caption-bold font-caption-bold text-gray-700 mb-2 flex items-center">
                    ...
                    {letter.attachments.map((attachment, index) => (
                      <div key={index} className="flex items-center justify-between bg-gray-50 p-2 rounded border">
                        <div className="flex items-center space-x-2 flex-1 min-w-0"> 
                          ...
                          <span className="text-caption font-caption text-gray-700 truncate">{attachment}</span>
                        </div>
                        <div className="flex space-x-1 ml-2">
                          <button 
                            className="text-caption font-caption bg-blue-100 text-blue-600 px-2 py-1 rounded hover:bg-blue-200 transition-colors"
                            onClick={(e) => {
                              e.stopPropagation();
              ...
              {/* Status info */}
              <div className="grid grid-cols-1 gap-2 text-caption font-caption pt-2 border-t border-gray-100">
                <div>
                  <span className="text-caption-bold font-caption-bold text-gray-700">Status: </span>
              ...
              {(letter.createdAt || letter.updatedAt) && (
                <div className="text-caption font text-gray-500 pt-2 border-t border-gray-100">
              ...
              <div className="pt-3 border-t border-gray-100 action-buttons">
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white px-3 py-2 rounded text-caption-bold font-caption-bold hover:bg-blue-700 transition-colors"
                  ...
                  <button
                    ...
                    className="flex-1 bg-green-600 text-white px-3 py-2 rounded text-caption-bold font-caption-bold hover:bg-green-700 transition-colors"
